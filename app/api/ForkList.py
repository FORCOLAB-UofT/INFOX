...
common_programming_words = ['if', 'else','for', 'return', 'and', 'or', 'merge', 'in', 'to']
        ...
        if not alreadyAnalzyed:
            for fork in active_forks:
                ...
                if sentences:
                    ...
                    ProjectFork.objects(fork_name=fork["full_name"]).update(key_words=key_words[fork_name])
                else:
